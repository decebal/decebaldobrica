...
- [Hook card](the-counters-looked-fine.png)
- [3D edition artwork](../../apps/web/public/images/blog/2026-09-21-rust-ai-weekly-13-3d-hero.png)

Review the Substack draft before sending it, then use the launch pack's X,
LinkedIn, syndication and community copy in the documented order.
