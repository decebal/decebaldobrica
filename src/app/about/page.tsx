                  ...
                  <div className="relative pl-8 before:absolute before:left-[7px] before:top-2 before:h-[calc(100%-2rem)] before:w-0.5 before:bg-gradient-to-b before:from-brand-teal before:to-brand-teal/20">
                    ...
                    <div className="relative mb-12">
                      ...
                      <div className="bg-white/5 backdrop-blur-sm p-6 rounded-lg border border-brand-teal/20 hover:border-brand-teal/40 transition-colors">
                        ...
                        <p className="text-white mb-3">
                          Led engineering team improving customer onboarding journey in a hybrid
                          London-based role.
                        </p>
                        <ul className="text-white text-sm space-y-1 list-disc list-inside">
                          <li>
                            Led a team of 7 engineers to reduce onboarding time by 35% through
                            workflow simplification and automation
                          </li>
                          <li>
                            Introduced modular architecture to decouple KYC logic, improving test
                            coverage by 40%
                          </li>
                          <li>
                            Fostered strong engineering culture with pairing and mentoring,
                            increasing delivery velocity by 25%
                          </li>
                          <li>
                            Tech stack: TypeScript, Node.js, React, Python, AWS, GitHub Actions
                          </li>
                        </ul>
                      </div>
                    </div>
                    ...
                    <div className="relative mb-12">
                      ...
                      <div className="bg-white/5 backdrop-blur-sm p-6 rounded-lg border border-brand-teal/20 hover:border-brand-teal/40 transition-colors">
                        ...
                        <p className="text-white mb-3">
                          Transformed crypto wallet into fintech app for high-inflation,
                          restricted-currency markets.
                        </p>
                        <ul className="text-white text-sm space-y-1 list-disc list-inside">
                          <li>
                            Aligned product and technical strategy for USD-scarce markets with high
                            inflation
                          </li>
                          <li>
                            Repurposed crypto wallet with virtual card integration for everyday
                            business use cases
                          </li>
                          <li>
                            Cut 3rd-party blockchain stack costs by 60% through indexer optimization
                          </li>
                          <li>
                            Delivered smart contract and wallet optimizations driving scalability
                    ...
                    <div className="relative mb-12">
                      ...
                      <div className="bg-white/5 backdrop-blur-sm p-6 rounded-lg border border-brand-teal/20 hover:border-brand-teal/40 transition-colors">
                        ...
                        <p className="text-brand-teal mb-2">
                          {config.professional.currentCompany} • Ongoing
                        </p>
                        <p className="text-white mb-3">
                          Leading technology strategy and architecture for fintech innovation.
                          Focusing on AI engineering, digital transformation, and building scalable
                    ...
                    <div className="relative mb-12">
                      ...
                      <div className="bg-white/5 backdrop-blur-sm p-6 rounded-lg border border-brand-teal/20 hover:border-brand-teal/40 transition-colors">
                        ...
                        <p className="text-white mb-3">
                          Drove transformative improvements in development efficiency and codebase
                          management.
                        </p>
                        <ul className="text-white text-sm space-y-1 list-disc list-inside">
                          <li>
                            Increased developer productivity by 300% through trunk development
                            implementation
                          </li>
                    ...
                    <div className="relative mb-12">
                      ...
                      <div className="bg-white/5 backdrop-blur-sm p-6 rounded-lg border border-brand-teal/20 hover:border-brand-teal/40 transition-colors">
                        ...
                        <p className="text-white mb-3">
                          Led large-scale engineering teams and delivered significant cost
                          optimizations.
                        </p>
                        <ul className="text-white text-sm space-y-1 list-disc list-inside">
                    ...
                    <div className="relative mb-12">
                      ...
                      <div className="bg-white/5 backdrop-blur-sm p-6 rounded-lg border border-brand-teal/20 hover:border-brand-teal/40 transition-colors">
                        ...
                        <p className="text-white">
                          Diverse experience in software engineering across multiple industries,
                          from backend development to architectural leadership. Built expertise in
                          blockchain, cloud infrastructure, event-driven architectures, and team
                          coaching.
                        </p>
                      </div>
                    </div>
