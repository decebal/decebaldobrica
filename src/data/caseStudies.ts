...
export const caseStudies: CaseStudy[] = [
  {
    ...
    problem:
      'Despite the surge in GenAI adoption across the sector, **CyberSpark\'s engineering team pushed back**. Developers dismissed the tools as unreliable—some even considered using GenAI "cheating." Meanwhile, **Optimus watched rival platforms deploy features faster, win customers quicker**, and position themselves as innovation leaders.',
    impact:
      'The resistance created **a rift between leadership and engineering**, slowing delivery and stalling key roadmap items. What should have been a race to the frontlines turned into a holding pattern. And with **no clear diagnostic on what was going wrong**, Optimus lacked the visibility to course-correct.',
