    ...
    <Html>
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Text style={text}>
            Thank you for subscribing to my newsletter! I share insights about software engineering,
            web development, and building products.
          </Text>
          <Text style={text}>
            To complete your subscription, please confirm your email address by clicking the button
            below:
          </Text>
