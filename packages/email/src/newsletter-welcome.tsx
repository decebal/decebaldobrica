      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Text style={text}>
            ...
            about software engineering, web development, and building digital products.
          </Text>
          {tier === 'free' && (
            <>
              <Hr style={hr} />
              ...
              <Section style={buttonContainer}>
                <Button style={button} href="https://decebaldobrica.com/newsletter/pricing">
                  View Premium Plans
                </Button>
              </Section>
            </>
          ...
          <Text style={footer}>
            You can{' '}
            <Link href="https://decebaldobrica.com/newsletter/unsubscribe" style={link}>
              unsubscribe
            </Link>{' '}
            at any time.
          </Text>
