      ...
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-foreground/70 text-lg">
            Sign in to manage pricing and services
          </p>
        </div>
        ...
        <div className="bg-card/70 backdrop-blur-sm rounded-2xl shadow-2xl p-8 border border-border">
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            >
              {!loading && (
                <div className="absolute inset-0 bg-gradient-to-r from-teal-600 via-cyan-600 via-emerald-600 via-blue-600 to-teal-600 opacity-0 group-hover:opacity-100 transition-opacity duration-500" style={{
          ...
          <div className="relative my-8">
            <div className="absolute inset-0 flex items-center" aria-hidden="true">
              <div className="w-full border-t-2 border-gradient-to-r from-transparent via-teal-200 to-transparent dark:via-teal-800/50" style={{
                borderImage: 'linear-gradient(to right, transparent, rgb(153 246 228), transparent) 1'
              }} />
            </div>
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-r from-cyan-100 via-teal-100 via-emerald-100 to-cyan-100 dark:from-cyan-950 dark:via-teal-950 dark:to-cyan-950 opacity-0 group-hover:opacity-100 transition-opacity duration-500" style={{
              backgroundSize: '200% 100%',
              animation: 'rainbow-shimmer 3s linear infinite'
            }} />
