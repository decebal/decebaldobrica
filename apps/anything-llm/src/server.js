...
async function main() {
  ...
  console.log(`${colors.blue}║${colors.reset}   AnythingLLM Service Manager      ${colors.blue}║${colors.reset}`);
  console.log(`${colors.blue}╚═══════════════════════════════════════╝${colors.reset}\n`);
  ...
  if (running) {
    ...
    if (await healthCheck()) {
      ...
      console.log(`${colors.cyan}ℹ${colors.reset} Access UI: ${colors.blue}http://localhost:${PORT}${colors.reset}`);
      console.log(`${colors.cyan}ℹ${colors.reset} View logs: ${colors.yellow}bun run logs${colors.reset}`);
      console.log(`${colors.cyan}ℹ${colors.reset} Stop service: ${colors.yellow}bun run stop${colors.reset}\n`);
      return;
    } else {
