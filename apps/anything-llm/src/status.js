...
async function checkStatus() {
  ...
  console.log(`${colors.blue}║${colors.reset}   AnythingLLM Status Check        ${colors.blue}║${colors.reset}`);
  console.log(`${colors.blue}╚═══════════════════════════════════════╝${colors.reset}\n`);
  ...
  try {
    ...
    if (response.ok) {
      ...
      console.log(`${colors.cyan}ℹ${colors.reset} URL: ${colors.blue}http://localhost:${PORT}${colors.reset}`);
    } else {
